[broid-api-sdk](../README.md) > ["helpers/WebSocket"](../modules/_helpers_websocket_.md) > [WebSocket](../classes/_helpers_websocket_.websocket.md) > [Observable](../modules/_helpers_websocket_.websocket.observable.md)
